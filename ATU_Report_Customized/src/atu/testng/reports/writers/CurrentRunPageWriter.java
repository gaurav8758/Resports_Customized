  ...
  extends ReportsPage
{
  ...
  public static String getBrowserWithVerion(ITestResult paramITestResult)
  {
    return (paramITestResult.getAttribute("BrowserName").toString() + " " + paramITestResult.getAttribute("BrowserVersion").toString());
  }
