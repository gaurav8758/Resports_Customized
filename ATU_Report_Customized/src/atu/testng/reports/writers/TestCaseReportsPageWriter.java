  ...
  extends ReportsPage
{
  ...
  public static void content(PrintWriter paramPrintWriter, ITestResult paramITestResult, int paramInt)
  {
    ...
    if ((paramITestResult.getParameters().length > 0) || (paramITestResult.getStatus() == 3) || (paramITestResult.getStatus() == 2))
    {
      ...
      if (paramITestResult.getParameters().length > 0)
      {
        ...
        for (Object localObject23 : paramITestResult.getParameters()) {
      ...
      if (paramITestResult.getStatus() == 3)
      {
        ...
        {
          str1 = "";
          for (String newstr : localObject11) {
            str1 = str1 + newstr + "<br/>";
          }
        ...
        {
          str1 = "";
          for (String newstr : arrayOfString) {
            str1 = str1 + newstr + "<br/>";
          }
  ...
  {
    switch (paramLogAs.ordinal())//1.$SwitchMap$atu$testng$reports$logging$LogAs[paramLogAs.ordinal()]
    {
    case 1: 
  ...
  public static void menuLink(PrintWriter paramPrintWriter, ITestResult paramITestResult, int paramInt)
  {
    ...
    paramPrintWriter.println(" <li class=\"menuStyle\"><a href=\"../" + getTestCaseHTMLPath(paramITestResult) + "index.html\" >Index</a></li>" + "<li style=\"padding-top: 4px;\"><a href=\"" + getTestCaseHTMLPath(paramITestResult) + "ConsolidatedPage.html\" >Consolidated Page</a></li>\n");
    if (paramInt == 1) {
